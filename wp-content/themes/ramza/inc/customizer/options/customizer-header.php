...
function ramza_customizer_register_header( $wp_customize ) {
  ...
  $wp_customize->add_section(
    ...
    array(
      'priority'    => 20,
      'title'       => esc_html__( 'Header', 'ramza' ),
      'description' => esc_html__( 'Header options.', 'ramza' ),
      // 'panel'       => ''
    )
  );
  ...
  $wp_customize->add_control(
    'ramza_options[header_b-site__header_padding]',
    array(
      'label'       => esc_html__( 'Brand Padding', 'ramza' ),
      'description' => esc_html__( 'Enter a number.', 'ramza' ),
