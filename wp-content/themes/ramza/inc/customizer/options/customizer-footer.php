...
function ramza_customizer_register_footer( $wp_customize ) {
  ...
  $wp_customize->add_section(
    ...
    array(
      'priority'    => 20,
      'title'       => esc_html__( 'Footer', 'ramza' ),
      'description' => esc_html__( 'Footer options.', 'ramza' ),
      // 'panel'       => ''
    )
  );
  ...
  $wp_customize->add_setting(
    ...
    array(
      'default'           => sprintf(
        ...
        '<a href="' . esc_url( esc_html__( 'http://wordpress.org/', 'ramza' ) ) . '">',
        'WordPress',
        '</a>' ),
  ...
  $wp_customize->add_control(
    'ramza_options[footer_c-copyright_text]',
    array(
      'label'       => esc_html__( 'Copyright Text', 'ramza' ),
      'description' => esc_html__( 'Basic HTML tags are allowed.', 'ramza' ),
